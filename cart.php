                            ...
                            <?php if(isset($_SESSION['cartItems'])): ?>
                                <?php foreach($_SESSION['cartItems'] as $key => $value): ?>
                                    <?php foreach($value as $size => $quantity): ?>
                                        ...
                                        <tr>                                        
                                            <td><img src="img/<?php echo $arrProducts[$key]['shirt1']; ?>" class="img-thumbnail bg-dark" style="height: 50px;"></td>
                                            <td class="text-warning"><b><?php echo $arrProducts[$key]['name']; ?></b></td>
                                            <td><?php echo $size; ?></td>
                                            <td>
