                        ...
                        <div class="product-grid2 card bg-dark">
                            <div class="product-image2">
                                <a href="descriptions.php?k=<?php echo $key; ?>">
                                    <img class="pic-1" src="img/<?php echo $product['shirt1']; ?>">
                                    <img class="pic-2" src="img/<?php echo $product['shirt2']; ?>">
                                </a>                        
                                <a class="add-to-cart text-dark" href="descriptions.php?k=<?php echo $key; ?>"><i class="fa fa-cart-plus"></i> Add to cart</a>
                            </div>
